...
def install_applet(path):
    click.confirm(text='Are you sure you want to install an applets? ' +
                       'This is an experimental feature and may brick your device', abort=True)
    commands.install_applet(path)
